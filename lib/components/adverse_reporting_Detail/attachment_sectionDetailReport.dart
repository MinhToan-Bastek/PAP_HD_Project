...
class AttachmentSectionRpDetail extends StatefulWidget {
  final Map<String, dynamic> reportDetail;

  const AttachmentSectionRpDetail({Key? key, required this.reportDetail}) : super(key: key);

  @override
  _AttachmentSectionRpDetailState createState() => _AttachmentSectionRpDetailState();
}

class _AttachmentSectionRpDetailState extends State<AttachmentSectionRpDetail> {
  final List<String> titles = ["ADR","ContactLog"];
  List<Image?> documentImages = List.generate(2, (_) => null);
  ...
  final List<dynamic> files = widget.reportDetail['Files'] ?? [];
