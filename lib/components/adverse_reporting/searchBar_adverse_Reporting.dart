...
class SearchBarAdverseReport extends StatefulWidget {
  @override
  _SearchBarAdverseReportState createState() => _SearchBarAdverseReportState();
}

class _SearchBarAdverseReportState extends State<SearchBarAdverseReport> {
