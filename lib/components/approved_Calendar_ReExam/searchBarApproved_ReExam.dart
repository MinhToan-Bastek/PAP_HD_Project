...
class SearchBarCalendarReExam extends StatefulWidget {
  @override
  _SearchBarCalendarReExamState createState() => _SearchBarCalendarReExamState();
}

class _SearchBarCalendarReExamState extends State<SearchBarCalendarReExam> {
    ...
    child: Column(
      ...
      children: [
        AnimatedDefaultTextStyle(
          ...
          child: Container(
            margin: EdgeInsets.only(bottom: 10), // Điều chỉnh margin dưới của văn bản
            child: Text(
              'Chưa được nhắc',
