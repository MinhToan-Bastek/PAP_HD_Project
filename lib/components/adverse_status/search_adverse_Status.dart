...
class SearchAdverseStatus extends StatefulWidget {
  @override
  _SearchAdverseStatusState createState() => _SearchAdverseStatusState();
}

class _SearchAdverseStatusState extends State<SearchAdverseStatus> {
