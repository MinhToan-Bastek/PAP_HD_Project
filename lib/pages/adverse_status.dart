...
//           Column(
//             children: [
//               TitleAdverseStatus(), // Phần title không cuộn
//               Expanded(
...
//                             detail:
//                                 'Nguyên nhân dẫn đến phải thực hiện báo cáo là do nguyên nhân...',
//                             statusText: 'Xác nhận',
//                             //statusIconPath: 'assets/icons/check_icon.svg', // Replace with your actual svg asset path
//                             statusColor: Color(0xFFD8F7EE),
//                             additionalIcon1: Icons.info,
//                             statusIconSvg:
//                                 'assets/adverse_status/status_2.svg' // Your actual icon for additionalIcon1
//                             // No additionalIcon2 provided
//                           ),
//                           ProvisionalConfirrm(
//                              documentId: 'BCBL-001258',
//                             personName: 'Trương Văn Bản',
//                             detail:
//                                 'While Papua New Guineas leaders are good at rolling out the....',
//                             statusText: 'Xác nhận tạm thời',
//                             //statusIconPath: 'assets/icons/check_icon.svg', // Replace with your actual svg asset path
//                             statusColor: Color(0xFFA2A0F3),
//                             additionalIcon1: Icons.info,
//                             statusIconSvg:
//                                 'assets/adverse_status/status_3.svg' 
//                           ),
//                           RejectStatus(
//                               documentId: 'BCBL-001259',
//                             personName: 'Lưu Quốc Việt',
//                             detail:
//                                 'This week’s violence is a wake-up call for U.S and international...',
//                             statusText: 'Từ chối',
//                             //statusIconPath: 'assets/icons/check_icon.svg', // Replace with your actual svg asset path
//                             statusColor: Color(0xFFF3A0A0),
//                             additionalIcon1: Icons.info,
//                             statusIconSvg:
//                                 'assets/adverse_status/status_4.svg' 
//                           ),
